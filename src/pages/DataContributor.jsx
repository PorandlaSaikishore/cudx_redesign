        ...
        <div className="mx-[5%]">
          <div className="mt-7 w-[40%]">
            ...
            <div className="text-gray-400 mt-2">
              All data is contributed by verified partners and collected in
              accordance with applicable privacy, security, and regulatory
              requirements.
            </div>
          </div>
          <div className="text-3xl font-semibold mt-7">
            What type of <span className="text-blue-900">Data</span> you
            Contribute?
          </div>
          <div className="flex justify-center items-start gap-[2%] mt-7">
            ...
            <div className="sticky top-[20%] bg-white z-10">
              <div
                className={
                  data === 0
                    ? "bg-blue-900 rounded-xl py-2 px-4 text-xl text-white font-semibold my-7"
                    : "bg-gray-400 rounded-xl py-2 px-4 text-xl text-white my-7 font-semibold cursor-pointer"
                }
                onClick={() => setData(0)}
              >
                Account
              ...
              {!creditUnion && (
                <div>
                  ...
                  <div className="flex justify-center items-center">
                    Please{" "}
                    <div className="cursor-pointer bg-blue-900 border border-blue-900 rounded-xl p-1 mx-2 my-4 text-white">
                      ContactUs
                    </div>{" "}
                  ...
                  <div className="flex justify-center items-center gap-7">
                    <div className="flex justify-center items-center gap-2">
                      ...
                      <input
                        type="checkbox"
                        className="accent-blue-600"
                        onClick={() => setRiseAnalytics(true)}
                        checked={riseAnalytics}
                      />
                    </div>
                    <div className="flex justify-center items-center gap-2">
                      <label>No</label>
                      <input
                        type="checkbox"
                        className="accent-blue-600"
                        onClick={() => setRiseAnalytics(false)}
                        checked={!riseAnalytics}
                      />
                    </div>
                  </div>
